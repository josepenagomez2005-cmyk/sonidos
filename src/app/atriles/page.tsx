  ...
  const atriles = [
    {
      ...
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+el+Hi-Hat+Mapex.+%C2%BFMe+ayudan%3F",
    },
    {
      img: "/fotos/B250.jpg",
      nombre: "Atril Ajustable Mapex (B250)",
      ...
      estadoColor: "bg-green-600 text-white border-green-700",
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+el+Atril+Ajustable+Mapex.+%C2%BFMe+ayudan%3F",
    },
    {
      img: "/fotos/C250.jpg",
      nombre: "Atril Recto Mapex (C250)",
      desc: "Atril recto resistente y fácil de ajustar. Construcción sólida para un rendimiento confiable en cualquier escenario.",
      precio: "67 USD",
      estado: "Disponible",
      estadoColor: "bg-green-600 text-white border-green-700",
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+el+Atril+Recto+Mapex.+%C2%BFMe+ayudan%3F",
    },
    {
      img: "/fotos/S250.jpg",
      nombre: "Atril de Caja Mapex (S250)",
      desc: "Soporte para caja con base estable. Diseñado para mantener tu caja segura durante las sesiones más intensas.",
      precio: "50 USD",
      estado: "Disponible",
      estadoColor: "bg-green-600 text-white border-green-700",
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+el+Atril+de+Caja+Mapex.+%C2%BFMe+ayudan%3F",
    },
    {
      img: "/fotos/T400.jpg",
      nombre: "Banqueta de drums Mapex (T400)",
      desc: "Banqueta de batería con asiento acolchado y altura regulable. Base estable y cómoda para largas sesiones de estudio o presentaciones en vivo.",
      precio: "85 USD",
      estado: "Disponible",
      estadoColor: "bg-green-600 text-white border-green-700",
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+la+Banqueta+Mapex.+%C2%BFMe+ayudan%3F",
    },
    {
      img: "/fotos/P250.jpg",
      nombre: "Pedal de Bombo Mapex (P250)",
      desc: "Pedal de bombo con respuesta rápida y precisa. Construcción resistente para un rendimiento confiable en cualquier estilo musical.",
      precio: "78 USD",
      estado: "Disponible",
      estadoColor: "bg-green-600 text-white border-green-700",
      zoom: true,
      mensajeWA: "https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+quiero+pedir+el+Pedal+de+Bombo+Mapex.+%C2%BFMe+ayudan%3F",
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <section className="py-16 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href="https://wa.me/5356956051?text=Hola%2C+vi+la+p%C3%A1gina+de+Sonidos+y+tengo+una+duda+sobre+los+atriles.+%C2%BFMe+ayudan%3F" className="bg-[#e8d5c0] hover:bg-white text-[#1a0f0a] px-8 py-4 rounded-xl font-bold text-lg transition shadow-xl inline-flex items-center gap-2" style={{ fontFamily: "'Lora', serif" }}>
        ...
        <footer className="text-center py-8 px-4 border-t border-[#c4a580]/10">
          ...
          />
          <p className="text-xs mt-4 text-[#8b7a6b]" style={{ fontFamily: "'Lora', serif" }}>
            © 2026 Sonidos · Todos los derechos reservados
          </p>
        </footer>
      </div>
    </main>
